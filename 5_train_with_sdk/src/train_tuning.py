...
def get_args() -> dict:
    ...
    p.add_argument("--c", dest="c", type=float)
    p.add_argument("--solver", dest="solver", type=str)
    p.add_argument("--penalty", dest="penalty", type=str)
...
if __name__ == "__main__":
    ...
    model = train_model(args, df_train=df_train)
